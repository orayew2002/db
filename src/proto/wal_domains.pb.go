...
// 	protoc        v3.21.12
// source: src/proto/wal_domains.proto
...
func (x *WalRecord) Reset() {
	*x = WalRecord{}
	mi := &file_src_proto_wal_domains_proto_msgTypes[0]
...
func (*WalRecord) Descriptor() ([]byte, []int) {
	return file_src_proto_wal_domains_proto_rawDescGZIP(), []int{0}
}
...
func (x *Value) Reset() {
	*x = Value{}
	mi := &file_src_proto_wal_domains_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Value) Descriptor() ([]byte, []int) {
	return file_src_proto_wal_domains_proto_rawDescGZIP(), []int{1}
}
...
var File_src_proto_wal_domains_proto protoreflect.FileDescriptor

const file_src_proto_wal_domains_proto_rawDesc = "" +
	"\n" +
	"\x1bsrc/proto/wal_domains.proto\x12\x05proto\"\x83\x01\n" +
	"\tWalRecord\x12\x10\n" +
...
var (
	file_src_proto_wal_domains_proto_rawDescOnce sync.Once
	file_src_proto_wal_domains_proto_rawDescData []byte
)

func file_src_proto_wal_domains_proto_rawDescGZIP() []byte {
	file_src_proto_wal_domains_proto_rawDescOnce.Do(func() {
		file_src_proto_wal_domains_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_src_proto_wal_domains_proto_rawDesc), len(file_src_proto_wal_domains_proto_rawDesc)))
	})
	return file_src_proto_wal_domains_proto_rawDescData
}

var file_src_proto_wal_domains_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_src_proto_wal_domains_proto_goTypes = []any{
	(*WalRecord)(nil), // 0: proto.WalRecord
	(*Value)(nil),     // 1: proto.Value
}
var file_src_proto_wal_domains_proto_depIdxs = []int32{
...
func init() { file_src_proto_wal_domains_proto_init() }
func file_src_proto_wal_domains_proto_init() {
	if File_src_proto_wal_domains_proto != nil {
		return
	}
	file_src_proto_wal_domains_proto_msgTypes[1].OneofWrappers = []any{
		(*Value_I64)(nil),
		(*Value_F64)(nil),
		(*Value_Str)(nil),
		(*Value_Raw)(nil),
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_src_proto_wal_domains_proto_rawDesc), len(file_src_proto_wal_domains_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_src_proto_wal_domains_proto_goTypes,
		DependencyIndexes: file_src_proto_wal_domains_proto_depIdxs,
		MessageInfos:      file_src_proto_wal_domains_proto_msgTypes,
	}.Build()
	File_src_proto_wal_domains_proto = out.File
	file_src_proto_wal_domains_proto_goTypes = nil
	file_src_proto_wal_domains_proto_depIdxs = nil
}
